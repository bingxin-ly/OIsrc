/* 在本题中，要理解的一点便是：轮廓也可以作为状态。当我们假设从高到低安排每个人的位置的时候，
   题目中要求的高低次序其实已经满足，我们只需要考虑把人放在这的这个位置合不合法即可。
   这样，我们状态的表示就与之前已经站好的人无关，而一个 k元组（a1, a2, a3, ..., ak）
   描绘的轮廓内的合影方案总数就足以构成一个子问题，从而在人数上转移。
 */
#include <bits/stdc++.h>
using namespace std;
